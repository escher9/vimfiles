...
fun <SID>ToggleAutoCloseMappings() " --- {{{2
    if g:autoclose_on
        ...
        " inoremap <buffer><silent> ss <C-R>=<SID>QuoteDelim("$")<CR>
        au syntax tex inoremap <silent> $ <C-R>=<SID>QuoteDelim("$")<CR>
        " au syntax tex inoremap <buffer><silent> $ <C-R>=<SID>QuoteDelim("$")<CR>
        " au syntax tex inoremap <buffer><silent> ss <C-R>=<SID>QuoteDelim("$")<CR>
        inoremap <silent> " <C-R>=<SID>QuoteDelim('"')<CR>
        " inoremap <silent> q' <C-R>=<SID>QuoteDelim('"')<CR>
        ...
        inoremap <silent> ;i <<C-R>=<SID>CloseStackPush('>')<CR>
        inoremap <silent> qi <<C-R>=<SID>CloseStackPush('>')<CR>
