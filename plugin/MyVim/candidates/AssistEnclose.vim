...
fun SetForSnippets()
	vmap <buffer><silent><A-]><A-[> :call WordsSnippetsV()<CR>
	nmap <buffer><silent><A-]><A-[> :call WordsSnippets()<CR>
endf
fun SetForHTML()
	nmap <buffer><silent><A-]><A-[>	 :call WordsEmphasize(0)<CR>
	vmap <buffer><silent><A-]><A-[>	 :call WordsEmphasizeV($buf.count)<CR>
	nmap <buffer><silent>1<A-]><A-[> :call WordsEmphasize(1)<CR>
	nmap <buffer><silent>2<A-]><A-[> :call WordsEmphasize(2)<CR>
	nmap <buffer><silent>3<A-]><A-[> :call WordsEmphasize(3)<CR>
	nmap <buffer><silent>4<A-]><A-[> :call WordsEmphasize(4)<CR>
	nmap <buffer><silent>5<A-]><A-[> :call WordsEmphasize(5)<CR>
