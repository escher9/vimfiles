...
fun! EasyThrough()
	...
	if &ft == 'python' 
		...
		elseif Condition1('def') || Condition1('while') || Condition1('elseif') || Condition1('class')
			return "\<Right>\:\<Enter>"
        elseif Condition2('for ') || Condition2('if ') || Condition2('while ') || Condition2('elseif ') || Condition2('else') || Condition2('try') || Condition2('finally') || Condition2('except')
			return ":\<Enter>"
		endif
	endif
...
" ((kkkk((wef(wefewfe(((wefk)m)UUUUUUU)UUUUUUUUUUUUUUUUUUUUUUUUUUU)(()UUUUUh)))UUUUUUUUUUUU) ()
" (weoi+)(wefiojo)(weoifj;)(oeewofije(iweofi(weojif);)(woe+i(weoi+(weofij))))
